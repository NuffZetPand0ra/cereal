...
// require_once __DIR__.'/CsvMigrator.php';

use Doctrine\DBAL\Schema\Schema;
use Doctrine\Migrations\AbstractMigration;
use App\Migrations\CsvMigrator;

/**
 * Auto-generated Migration: Please modify to your needs!
 */
final class Version20240910110049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, mfr INT DEFAULT NULL, type INT DEFAULT NULL, name VARCHAR(255) NOT NULL, calories INT NOT NULL, protein INT NOT NULL, fat INT NOT NULL, sodium INT NOT NULL, fiber DOUBLE PRECISION NOT NULL, carbo DOUBLE PRECISION NOT NULL, sugars INT NOT NULL, potass INT DEFAULT NULL, vitamins INT NOT NULL, shelf INT NOT NULL, weight DOUBLE PRECISION NOT NULL, cups DOUBLE PRECISION NOT NULL, rating DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE product_rating (id INT NOT NULL, "user" INT DEFAULT NULL, product_id INT NOT NULL, rating DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
